...
def run(cfg: DictConfig):
    ...
    saving_path = cfg.river.transect_iqh_output_path
    ...
    min_non_zero_slope = transect_polygon_df[transect_polygon_df["Slope"] > 0][
        "Slope"
    ].min()
    zero_or_nan_slope_idx = (transect_polygon_df["Slope"].isna()) | (
        transect_polygon_df["Slope"] <= 0
    )
    transect_polygon_df.loc[zero_or_nan_slope_idx, "Slope"] = min_non_zero_slope
