...
from river_profile_lidar.d84.create_d84 import process_and_save_d84
...
def run(cfg: DictConfig):
    ...
    saving_folder_path = cfg.river.d84_output_path
    ...
    for i, image_name in enumerate(image_name_to_process_list):
        ...
        if Path(saving_folder_path, f"{Path(image_name).stem}_d84.tif").exists():
            continue
